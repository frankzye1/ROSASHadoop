...
public class Interference_Type_11_UDF extends UDF {
    public int evaluate(String peak_position,String P60_1,String P60_OP1,int position,String left_max_right,String P6_V1,String P6_OP1,String P6_V2,String P6_OP2,String P6_LOGIC)
    {
        try
        {
            ...
            if (b1&&(variance>0.001)&&Common.LogicFun(Common.compare(position,P6_OP1,Double.parseDouble(P6_V1)),P6_LOGIC,Common.compare(position,P6_OP2,Double.parseDouble(P6_V2))))
            {
                return 1;
            }
            else
