...
use rosas;
CREATE TEMPORARY FUNCTION ev1 as 'rosas.dataprocessor.Average_Interference_Level_UDF';


----算出每条记录的干扰电平
DROP TABLE IF_INDEX_5_1;
CREATE TABLE IF_INDEX_5_1 AS
SELECT 
