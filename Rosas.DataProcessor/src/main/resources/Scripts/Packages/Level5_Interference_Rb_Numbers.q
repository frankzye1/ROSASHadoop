...
-----参数临时表
DROP TABLE IF_INDEX_13_P1;
CREATE TABLE IF_INDEX_13_P1 AS
select 
...
----每条数据符合条件的RB数
DROP TABLE IF_INDEX_13_1;
CREATE TABLE IF_INDEX_13_1 AS
SELECT 
...
FROM 
IF_INDEX_13_P1,PM_EutranCellTdd;



----小时级
DROP TABLE IF_INDEX_13;
CREATE TABLE IF_INDEX_13 AS 
SELECT 
...
----全天级
INSERT OVERWRITE TABLE IF_INDEX_13 
SELECT 
