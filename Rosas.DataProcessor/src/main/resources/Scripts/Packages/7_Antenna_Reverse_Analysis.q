...
select DEF_CELLNAME,'隐性故障' as TYPE1,'疑似天线故障' as TYPE2,'天线接反' as TYPE3,DEF_CELLNAME as FAULT_OBJECT,TTIME,CITY,REGION,TOWN,GRID,concat('规划方向角与实际覆盖方向偏差',FAULT_DESCRIPTION1,'度') as FAULT_DESCRIPTION,'原因' as LABEL,'AllDay' as THOUR,DEF_CELLNAME_CHINESE
from
