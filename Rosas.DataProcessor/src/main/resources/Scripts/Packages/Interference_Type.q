...
as left_max_right
FROM 
PM_EutranCellTdd) t1 join SITE_INFO t2 on t1.CELLNAME=t2.DEF_CELLNAME;
...
ev7(variance,P1_V1,P1_OP1,P2_V1,P2_OP1) as flag,
concat('方差',variance,'P1_OP1','P1_V1','且干扰均值',P2_OP1,P2_V1) as describe
FROM
IF_PARAM_TABLE_1,IF_PARAM_TABLE_2,InterferenceType_1;

---杂散干扰

ev8(slope_k,P3_V1,P3_OP1) as flag,
...
ev9(slope_k,P4_V1,P4_OP1) as flag,
...
ev10(slope_k,position,P5_V1,P5_OP1,P5_V1,P5_OP2) as flag,
concat('PRB',position,P5_OP1,P5_V1,P5_LOGIC,'斜率',slope_k,'>-0.1') as describe
FROM
IF_PARAM_TABLE_5,InterferenceType_1;

---同频干扰

ev10(position,left_max_right,P6_V1,P6_OP1,P6_V2,P6_OP2) as flag,
...
ev10(peak_position,P7_V1,P7_OP1,P8_V1,P8_OP1,P9_V1,P9_OP1,P10_V1,P10_OP1,P10_V2,P10_OP2,P10_LOGIC) as flag,
--concat('波峰',peak_position,' 若找出的波峰个数N',P7_OP1,P7_V1,'并且前四个波峰中至少有两个波峰位置P满足',P8_OP1,P8_V1,'且在',,'或者等于‘参数9’且在‘参数10’区间，则干扰为GPS干扰，否则，干扰为互调干扰。) as describe
FROM
