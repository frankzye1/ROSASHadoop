...
use rosas;
CREATE TEMPORARY FUNCTION ev1 as 'rosas.dataprocessor.Interference_Rb_Numbers_UDF';

-----参数临时表
DROP TABLE IF_INDEX_8_P1;
CREATE TABLE IF_INDEX_8_P1 AS
select 
OPERATOR1 as op1,VALUE1 as v1
from 
param_config 
where PARAM='INTERFERENCE_THRES_B1';

----每条数据符合条件的RB数
DROP TABLE IF_INDEX_8_1;
CREATE TABLE IF_INDEX_8_1 AS
SELECT 
