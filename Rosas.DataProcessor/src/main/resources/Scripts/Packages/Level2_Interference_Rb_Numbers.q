...
-----参数临时表
DROP TABLE IF_INDEX_10_P1;
CREATE TABLE IF_INDEX_10_P1 AS
select 
...
----每条数据符合条件的RB数
DROP TABLE IF_INDEX_10_1;
CREATE TABLE IF_INDEX_10_1 AS
SELECT 
...
FROM 
IF_INDEX_10_P1,PM_EutranCellTdd;



----小时级
DROP TABLE IF_INDEX_10;
CREATE TABLE IF_INDEX_10 AS 
SELECT 
...
----全天级
INSERT OVERWRITE TABLE IF_INDEX_10 
SELECT 
