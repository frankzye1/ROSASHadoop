...
--SUM(HO_SUCCOUTPERRELATION)/SUM(HO_ATTOUTEXECPERRELATION)*100 as HO_RATE_REL FROM TEMP_P1S1S2 GROUP BY CITY,P1_DEF_CELLNAME,S2_DEF_CELLNAME,date_time,substring(fileheader_begintime,12,2),substring(FILEHEADER_BEGINTIME,15,2);
--
--INSERT INTO TABLE PI_RELATION
INSERT OVERWRITE TABLE PI_RELATION 
...
SUM(HO_OPF_CAUSETCELLNORESPONSE) as HO_OPF_CAUSETCELLNORESPONSE,
SUM(HO_OPF_CAUSEHOPREPFAILUREMSG) as HO_OPF_CAUSEHOPREPFAILUREMSG,
SUM(HO_SUCCOUTPERRELATION)/SUM(HO_ATTOUTEXECPERRELATION)*100 as HO_RATE_REL FROM TEMP_P1S1S2 GROUP BY CITY,P1_DEF_CELLNAME,S2_DEF_CELLNAME,date_time,substring(fileheader_begintime,12,2);
...
SUM(HO_OPF_CAUSETCELLNORESPONSE) as HO_OPF_CAUSETCELLNORESPONSE,
SUM(HO_OPF_CAUSEHOPREPFAILUREMSG) as HO_OPF_CAUSEHOPREPFAILUREMSG,
SUM(HO_SUCCOUTPERRELATION)/SUM(HO_ATTOUTEXECPERRELATION)*100 as HO_RATE_REL FROM TEMP_P1S1S2 GROUP BY CITY,P1_DEF_CELLNAME,S2_DEF_CELLNAME,date_time;
