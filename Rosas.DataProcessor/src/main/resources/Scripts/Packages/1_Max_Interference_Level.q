...
use rosas;
CREATE TEMPORARY FUNCTION ev1 as 'rosas.dataprocessor.Max_Interference_Level_UDF';

---SingleRow_MAX_IF_NL为每条数据的最大干扰电平
DROP TABLE IF_INDEX_6_1;
CREATE TABLE IF_INDEX_6_1 AS
SELECT 
