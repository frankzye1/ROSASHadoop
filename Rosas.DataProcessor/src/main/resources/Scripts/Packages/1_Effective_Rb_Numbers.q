...
use rosas;
CREATE TEMPORARY FUNCTION ev1 as 'rosas.dataprocessor.Effective_Rb_Numbers_UDF';

DROP TABLE IF_INDEX_4_1;
CREATE TABLE IF_INDEX_4_1 AS
SELECT 
